...
const createGame = async () => {
  const name = JSON.stringify({ name: 'Battle of Condor' });
...
const url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/l4LvIhbBaQDspWk4kHGd/scores/';
